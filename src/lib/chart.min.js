...
! function(t, e) {
    ...
    function be(t, e) {
        ...
        } = e, o = ge(i), s = "border-box" === o.boxSizing, a = xe(o, "padding"), r = xe(o, "border", "width"), {
            x: l,
            y: c,
            box: h
        } = function(t, e) {
    ...
    var Ze = {
        ...
        update(t, e, i, n) {
            ...
            }(l.concat(c), d), Ke(r.fullSize, f, d), Ke(l, f, d), Ke(c, f, d) && Ke(l, f, d),
                function(t) {
    ...
    class ms extends zi {
        ...
        _draw() {
            ...
            const {
                ...
                boxHeight: b,
                itemHeight: _
            } = ps(l, g), y = t.isHorizontal(), v = this._computeTitleHeight();
            m = y ? {
    ...
    return eo.register(yo, la, Xo, zs), eo.helpers = {
        ...Tn
